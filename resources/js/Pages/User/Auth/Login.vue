    ...
    <GuestLayout>
        ...
        <div class="mt-3">
            <a :href="route('user.login.google')"
                class="flex items-center bg-white rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 hover:opacity-75">
