                    ...
                    <v-row class="pb-10 ">
                        <v-col class="flex border-gray-400 mr-2 align-center bg-gray-200 hover:bg-gray-300 shadow">
                            ...
                            <label :for="0"
                                ...
                                <span class="px-3">Todas (すべて)</span>
                        ...
                        <v-col class="flex border-gray-400 mr-2 align-center bg-gray-200 hover:bg-gray-300 shadow">
                            ...
                            <label :for="2"
                                ...
                                <span class="px-3">Pescados (お魚)</span>
                                <FontAwesomeIcon icon="angle-right" />
                            </label>
                        </v-col>
                        <v-col class="flex border-gray-400 mr-2 align-center bg-gray-200 hover:bg-gray-300 shadow">
                        ...
                        <v-col class="flex border-gray-400 mr-2 align-center bg-gray-200 hover:bg-gray-300 shadow">
                            ...
                            <label :for="4"
                                ...
                                <span class="px-3">Arroces (米)</span>
                                <FontAwesomeIcon icon="angle-right" />
                            </label>
                        </v-col>
                    </v-row>
                    <v-row>
                        ...
                        <v-col class="flex border-gray-400 mr-2 align-center bg-gray-200 hover:bg-gray-300 shadow">
                            ...
                            <label :for="6"
                                ...
                                <span class="px-3">Pasta (パスタ)</span>
                                <FontAwesomeIcon icon="angle-right" />
                            </label>
                        </v-col>
                        <v-col class="flex border-gray-400 mr-2 align-center bg-gray-200 hover:bg-gray-300 shadow">
                            ...
                            <label :for="7"
                                ...
                                <span class="px-3">Sopas (スープ)</span>
                                <FontAwesomeIcon icon="angle-right" />
                            </label>
                        </v-col>
                        <v-col class="flex border-gray-400 mr-2 align-center bg-gray-200 hover:bg-gray-300 shadow">
                            ...
                            <label :for="8"
                                ...
                                <span class="px-3">Obento (お弁当)</span>
                                <FontAwesomeIcon icon="angle-right" />
                            </label>
                        </v-col>
                        <v-col class="flex border-gray-400 mr-2 align-center bg-gray-200 hover:bg-gray-300 shadow">
                            ...
                            <label :for="9"
                                ...
                                <span class="px-3">Dulces (スイーツ)</span>
                                <FontAwesomeIcon icon="angle-right" />
                            </label>
                        </v-col>
                    </v-row>
