...
<template>
    ...
    <UserLayout>
        <Slider />
        <div class="py-14">
            <div class="max-w-6xl mx-auto text-white elevation-5 font-bold py-2 sm:px-6 lg:px-8"
            ...
            <div class="h-500 max-w-6xl mx-auto py-10">
                <v-row class="pb-10">
                    ...
                    <v-col class="flex border-gray-400 mr-2 align-center bg-gray-200 hover:bg-gray-300 shadow">
                        ...
                        <label :for="1"
                            class="flex text-base py-2 text-center align-center font-bold px-3 w-full hover:bg-primary-light">
                ...
                <v-row>
                    <v-col class="flex border-gray-400 mr-2 align-center bg-gray-200 hover:bg-gray-300 shadow">
                        ...
                        <span class="font-bold px-3">Pasta</span>
                        <FontAwesomeIcon icon="angle-right" />
                    </v-col>
                    <v-col class="flex border-gray-400 mr-2 align-center bg-gray-200 hover:bg-gray-300 shadow">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                        ...
                        <span class="font-bold px-3">Sopa</span>
                        <FontAwesomeIcon icon="angle-right" />
                    </v-col>
                    <v-col class="flex border-gray-400 mr-2 align-center bg-gray-200 hover:bg-gray-300 shadow">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                    ...
                    <span class="font-bold px-3"> Obento</span>
                    <FontAwesomeIcon icon="angle-right" />
                </v-col>
                <v-col class="flex border-gray-400 mr-2 align-center bg-gray-200 hover:bg-gray-300 shadow">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                    ...
                    <span class="font-bold px-3">Dulces</span>
                    <FontAwesomeIcon icon="angle-right" />
                </v-col>
                <v-col class="flex border-gray-400 mr-2 align-center bg-gray-200 hover:bg-gray-300 shadow">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                    ...
                    <span class="font-bold px-3">Ensalada</span>
                    <FontAwesomeIcon icon="angle-right" />
                </v-col>
            </v-row>
        </div>
